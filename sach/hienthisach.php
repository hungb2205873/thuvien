            ...
            if($res){
                while($rows = mysqli_fetch_assoc($res)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $ngaythem; ?></td>
                        <td>
                            <a class="btn btn-warning btn-sm" href="chinhsuasach.php?id=<?php echo $id;?>">Sửa</a>
                            <a class="btn btn-danger btn-sm" href="xoasach.php?id=<?php echo $id; ?>">Xóa</a>                            
                        </td>
                    </tr>
                    <?php
                }
